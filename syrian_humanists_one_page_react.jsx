...
function Card({ icon: Icon, title, children, ar }) {
  return (
    <motion.div
      variants={fadeUp}
      className="group rounded-[2rem] border border-[#195C85]/10 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#195C85]/10"
    >
      <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F8FAF7] text-[#195C85] ring-1 ring-[#7CCBAE]/30 transition-colors group-hover:bg-[#195C85] group-hover:text-white">
        <Icon className="h-6 w-6" />
      </div>
      <h3 className="text-lg font-extrabold text-[#14232B]">{title}</h3>
      {ar && <p className="mt-1 text-sm font-semibold text-[#25A77A]">{ar}</p>}
      ...
      <main id="top">
        <section className="relative overflow-hidden px-5 pb-20 pt-14 lg:px-8 lg:pb-28 lg:pt-20">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <motion.div initial="hidden" animate="visible" transition={{ staggerChildren: 0.1 }}>
              ...
              <motion.h1 variants={fadeUp} className="max-w-4xl text-5xl font-black leading-[1.04] tracking-tight text-[#14232B] sm:text-6xl lg:text-7xl">
                A calm voice for dignity, conscience, and human solidarity.
              </motion.h1>
              <motion.p variants={fadeUp} className="mt-7 max-w-2xl text-lg leading-8 text-[#14232B]/72 sm:text-xl">
        ...
        <section id="about" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
              ...
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={fadeUp} className="rounded-[2.5rem] border border-[#195C85]/10 bg-white p-8 shadow-sm md:p-10">
        ...
        <section id="vision" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-6xl text-center">
            ...
            <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-4xl font-black leading-tight tracking-tight text-[#195C85] md:text-6xl">
              A future where every Syrian can live with dignity, think freely, and belong without fear.
            </motion.h2>
            <p className="mx-auto mt-7 max-w-3xl text-lg leading-8 text-[#14232B]/70">
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="rounded-[2.5rem] bg-[#195C85] p-8 text-white shadow-xl shadow-[#195C85]/20 md:p-10">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="rounded-[2.5rem] border border-[#25A77A]/20 bg-white p-8 shadow-sm md:p-10">
        ...
        <section id="values" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} transition={{ staggerChildren: 0.08 }} className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
              {values.map((v) => (
                <Card key={v.title} icon={v.icon} title={v.title} ar={v.ar}>{v.text}</Card>
              ))}
            </motion.div>
          </div>
        </section>
        ...
        <section id="building" className="px-5 py-20 lg:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} transition={{ staggerChildren: 0.08 }} className="mt-12 grid gap-5 md:grid-cols-2">
              {building.map((b) => (
            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {principles.map((p, index) => (
                  <motion.div key={p} initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.04 }} className="flex items-start gap-3 rounded-2xl bg-[#F8FAF7] p-4 ring-1 ring-[#7CCBAE]/25">
        ...
        <section className="px-5 py-20 lg:px-8">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-2">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="rounded-[2.5rem] border border-[#195C85]/10 bg-white p-8 shadow-sm md:p-10">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#195C85] text-white">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="rounded-[2.5rem] border border-[#25A77A]/20 bg-[#F8FAF7] p-8 shadow-sm md:p-10">
              <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#25A77A] text-white">
              ...
              {faqs.map((item, index) => (
                <div key={item.q} className="overflow-hidden rounded-3xl border border-[#195C85]/10 bg-white shadow-sm">
                  ...
                  >
                    ...
                    <ChevronDown className={`h-5 w-5 shrink-0 text-[#195C85] transition-transform ${openFaq === index ? "rotate-180" : ""}`} />
                  </button>
              ...
              <div>
                ...
                <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                  ...
                  <a href="#building" className="inline-flex items-center justify-center gap-2 rounded-full border border-white/25 px-6 py-3 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-white/10">
                    Support the Development <ArrowRight className="h-4 w-4" />
                  </a>
                </div>
              </div>
